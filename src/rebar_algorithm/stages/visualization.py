...
class Visualizer:
    ...
    def _viz_dir(self, output_path: Path) -> Path:
        d = output_path / "visualization_results"
    ...
    def create_main_visualization(self, analyzer, image_path, output_path, **kw):
        ...
        out = self._viz_dir(output_path) / "line_fitting_visualization.png"
    ...
    def create_segmented_overlay(self, analyzer, seg_path, output_path):
        ...
        out = self._viz_dir(output_path) / "lines_on_segmented_rebar.png"
        cv2.imwrite(str(out), viz)
        return out
    ...
    def create_comparison_view(self, orig_path, result_path, output_path, title="Before / After"):
        ...
        out = self._viz_dir(output_path) / "comparison_before_after.png"
